...
import { getDailySummary, getDailyMetricsSummary } from "./services/logService";
...
export default function Index() {
  ...
  const [metricsSummary, setMetricsSummary] = useState({
    water: 0, sleep: 0, steps: 0, totalWorkoutMinutes: 0
  });
        ...
        return (
            ...
            >
              <View style={styles.topBar}>
                ...
                <Pressable style={styles.signOutIconButton} onPress={() => setShowLogoutModal(true)}>
      ...
      case "Lens":
        return (
            <View style={styles.placeholder}>
              <AddFood onLogSuccess={() => { if (currentUser) fetchDailyStats(currentUser.$id); setActiveTab("Home"); }} />
            </View>
        );
      default:
        return (
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <View style={styles.modalFooter}>
                <Pressable style={[styles.modalBtn, styles.cancelBtn]} onPress={() => setShowLogoutModal(false)}>
                  <Text style={styles.cancelBtnText}>Cancel</Text>
                </Pressable>
                <Pressable style={[styles.modalBtn, styles.logoutBtn]} onPress={confirmSignOut}>
...
const styles = StyleSheet.create({
  ...
  safe: { flex: 1 },
  scrollContainer: { paddingHorizontal: 20, paddingTop: Platform.OS === "android" ? 40 : 10, paddingBottom: 100 },
  ...
  avatarCircle: { width: 44, height: 44, borderRadius: 22, backgroundColor: "#1E293B", justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: "rgba(37, 99, 235, 0.2)" },
  ...
  signOutIconButton: { padding: 10, backgroundColor: "#1E293B", borderRadius: 14, borderWidth: 1, borderColor: "#334155" },
  modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.8)", justifyContent: "center", alignItems: "center", padding: 20 },
  modalContent: { width: "100%", backgroundColor: "#1E293B", borderRadius: 28, padding: 24, borderWidth: 1, borderColor: "#334155" },
  modalHeader: { alignItems: "center", marginBottom: 32 },
  logoutIconCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: "rgba(239, 68, 68, 0.1)", justifyContent: "center", alignItems: "center", marginBottom: 16 },
  modalTitle: { fontSize: 22, fontWeight: "800", color: "#FFF", marginBottom: 8 },
  modalSubtitle: { fontSize: 15, color: "#94A3B8", textAlign: "center", lineHeight: 22 },
