                ...
                <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
                    <View style={styles.header}>
                        ...
                        <Text style={styles.subtitle}>
                            {isSignUp ? "Join FoodLens to track your nutrition" : "Analyze your meals with FoodLens AI"}
                        </Text>
                    </View>
                    ...
                    <View style={styles.form}>
                        ...
                        {message && (
                            <View style={[styles.statusBox, message.type === "error" ? styles.errorBox : styles.successBox]}>
                        ...
                        <View style={styles.footer}>
                            <Text style={styles.footerText}>{isSignUp ? "Already have an account? " : "New to FoodLens AI? "}</Text>
...
const styles = StyleSheet.create({
    ...
    scrollContent: { paddingHorizontal: spacing.xxxl, paddingVertical: 40, flexGrow: 1, justifyContent: "center" },
    header: { alignItems: "center", marginBottom: 40 },
    logoContainer: { width: 80, height: 80, backgroundColor: palette.surfaceAlt, borderRadius: 24, justifyContent: "center", alignItems: "center", marginBottom: spacing.xl, borderWidth: 1, borderColor: palette.border },
    logoEmoji: { fontSize: 40 },
    title: { fontSize: 32, color: palette.textPrimary, fontWeight: "900", letterSpacing: -0.5 },
    subtitle: { color: palette.textSecondary, fontSize: 16, textAlign: "center", marginTop: 8, opacity: 0.8 },
    form: { gap: 16 },
    inputContainer: { flexDirection: "row", alignItems: "center", backgroundColor: palette.surface, borderRadius: radii.lg, borderWidth: 1, borderColor: palette.border, paddingHorizontal: spacing.xl, height: 60 },
