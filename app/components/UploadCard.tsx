        ...
        <View style={styles.card}>
            ...
            {imageUri ? (
                ...
                <View style={styles.emptyState}>
                    ...
                    <Pressable style={[styles.uploadBox, styles.cameraBox]} onPress={onOpenCamera}>
...
const styles = StyleSheet.create({
    card: { backgroundColor: palette.surface, borderRadius: radii.lg, padding: spacing.xl, borderWidth: 1, borderColor: palette.border, gap: spacing.lg },
    header: { gap: 4 },
    ...
    analyzeBtn: { backgroundColor: palette.primary, height: 56, borderRadius: radii.md, flexDirection: "row", justifyContent: "center", alignItems: "center", gap: 10 },
